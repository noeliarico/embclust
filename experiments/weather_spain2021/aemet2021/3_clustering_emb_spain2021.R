...
s <- sim_emb_matrix(weather_data_variables, emb_w, mean, dist = T)
...
s <- sim_emb_matrix(weather_data_variables, emb_gg, mean, dist = T)
attr(s, "Labels") <- weather_data_provinces
d <- 1-s
hc <- hclust(d, method = "average")
...
s <- sim_emb_matrix(weather_data_variables, emb_gd, mean, dist = T)
attr(s, "Labels") <- weather_data_provinces
d <- 1-s
hc <- hclust(d, method = "average")
...
s <- sim_emb_matrix(weather_data_variables, emb_fd, mean, dist = T)
attr(s, "Labels") <- weather_data_provinces
d <- 1-s
hc <- hclust(d, method = "average")
...
s <- sim_emb_matrix(weather_data_variables, emb_rs, mean, dist = T)
attr(s, "Labels") <- weather_data_provinces
d <- 1-s
hc <- hclust(d, method = "average")
